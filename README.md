# Playwright E2E Guidelines – Strict & AI-Optimized

**Strict Playwright E2E testing guidelines optimized for reliable AI-assisted code review**  
(Copilot, Cursor, Claude, and similar tools)

These rules are intentionally strict to give AI tools clear, deterministic signals and reduce ambiguity.

## Why these guidelines?

- Minimize flaky tests (no sleeps, no networkidle, no missing awaits)
- Enforce maximum consistency in large teams
- Make tests easy for AI to understand, generate, and refactor correctly
- Focus only on project-specific conventions (generic JS/TS rules are left to linters)

## Quick start

1. Read the full rules below  
2. Use them as a reference when writing or reviewing Playwright tests  
3. Share with your team / add to your Confluence / Notion / wiki  
4. (Optional) Configure linters or pre-commit hooks to enforce parts of it
...
- [🧪 Test Verification Best Practices](#-test-verification-best-practices)
...
- [External project-specific context](#) (link to Confluence/Jira if available)
